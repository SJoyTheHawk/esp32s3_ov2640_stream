...
.check{display:flex;align-items:center;gap:9px;color:#e5e7eb;padding:8px 0}.check input{width:18px;height:18px;margin:0;cursor:pointer;accent-color:#3b82f6}.actions{display:flex;align-items:center;gap:10px;margin-top:20px;flex-wrap:wrap}button{padding:10px 16px;border:0;border-radius:6px;font-weight:600;font-size:.875rem;cursor:pointer}.btn-primary{background:#3b82f6;color:#fff}.btn-primary:hover{background:#2563eb}.btn-block{width:100%}.quiet{background:#374151;color:#e5e7eb}.quiet:hover{background:#4b5563}.danger{background:#dc2626;color:#fff}.danger:hover{background:#b91c1c}
...
</div><div class="actions"><button type="button" class="quiet" data-close="wifi-modal">Cancel</button><button type="submit" class="btn-primary">Save network</button><p id="network-message" class="message"></p></div></form></div></div>
